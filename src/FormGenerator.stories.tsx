 ...
 */
storiesOf('MagicFormGenerator', module)
  .add('Grid', () => <MagicFormGenerator form={formConfigGrid} />)
  .add('Validation', () => <MagicFormGenerator form={formConfingValidation} />)
  .add('Fields', () => <MagicFormGenerator form={formConfigFields} />)
  .add('Submit', () => <MagicFormGenerator form={formConfigSubmit} />);

const formConfigGrid: FormConfiguration = {
  title: 'First form generated- Grid sytem',
  subTitle:
    "Sitema di griglia dinamico, sono supportate le seugneti colonne: '1' | '1/2' | '1/3' ",
  submit: {
...
const formConfingValidation: FormConfiguration = {
  ...
  subTitle:
    'Vari tipologie di validazine per gli input: required, minLenght, maxLenght, equalTo, callback...',
  submit: {
    endpoint: 'http://localhost:5000/formSubmit',
    method: 'POST',
    backend: true,
...
const formConfigFields: FormConfiguration = {
  ...
  subTitle:
    'Diverse tipologie di input supportate: text, email, password, select, textare, address, datepicker ...',
  submit: {
    endpoint: 'http://localhost:5000/formSubmit',
    method: 'POST',
    backend: true,
  ...
  fields: [
    ...
    },
    {
      ...
      dataLoading: true,
      fetchDataFromUrl:
        'https://run.mocky.io/v3/433d52dc-1854-43e3-a44d-7af43afe45e9',
      data: [],
    },
    {
      type: 'select',
    ...
    },
    {
      ...
      name: 'checkbox',
      placeholder:
        'Devi accettare la <a href="https://www.google.it" target="_blank">Privacy Policy</a>',
      validation: {
        required: {
          value: true,
